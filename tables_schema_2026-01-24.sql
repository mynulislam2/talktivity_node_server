...
-- Generated: 2026-01-24T09:37:33.716Z
...
-- ============================================
-- Columns:
--   id                        integer              NOT NULL DEFAULT nextval('call_sessions_id_seq'::regclass)
--   user_id                   integer              NOT NULL
--   call_started_at           timestamp without time zone nullable DEFAULT now()
--   call_ended_at             timestamp without time zone nullable
--   call_duration_seconds     integer              nullable DEFAULT 0
--   call_completed            boolean              NOT NULL DEFAULT false
--   session_type              character varying    nullable DEFAULT 'practice'::character varying
--   topic_id                  integer              nullable
--   topic_name                character varying    nullable
--   room_name                 character varying    nullable
...
--   speaking_started_at       timestamp without time zone nullable
--   speaking_ended_at         timestamp without time zone nullable
--   speaking_duration_seconds integer              nullable DEFAULT 0
--   speaking_quiz_completed   boolean              NOT NULL DEFAULT false
--   speaking_quiz_score       integer              nullable
--   created_at                timestamp without time zone nullable DEFAULT CURRENT_TIMESTAMP
--   updated_at                timestamp without time zone nullable DEFAULT CURRENT_TIMESTAMP
--   listening_completed       boolean              NOT NULL DEFAULT false
--   listening_quiz_completed  boolean              NOT NULL DEFAULT false
...
--   roleplay_started_at       timestamp without time zone nullable
--   roleplay_ended_at         timestamp without time zone nullable
...
--   exam_started_at           timestamp without time zone nullable
--   exam_ended_at             timestamp without time zone nullable
--   exam_duration_seconds     integer              nullable DEFAULT 0
--   exam_score                integer              nullable


-- ============================================
-- Table: daily_progress_backup_20260124
-- Records: 0
-- ============================================
-- Columns:
--   id                        integer              nullable
...
--   progress_date             date                 nullable
--   call_started_at           timestamp without time zone nullable
--   call_ended_at             timestamp without time zone nullable
--   call_completed            boolean              nullable
...
-- ============================================
-- Table: refactoring_verification_report
-- Records: 3
-- ============================================
-- Columns:
--   id                        integer              NOT NULL DEFAULT nextval('refactoring_verification_report_id_seq'::regclass)
--   report_date               timestamp without time zone nullable DEFAULT CURRENT_TIMESTAMP
...
--   upgrade_completed         boolean              NOT NULL DEFAULT false
...
-- ============================================
-- Table: user_lifecycle_backup_20260124
-- Records: 633
-- ============================================
-- Columns:
--   user_id                   integer              nullable
--   onboarding_completed      boolean              nullable
--   onboarding_steps          jsonb                nullable
--   call_completed            boolean              nullable
--   report_completed          boolean              nullable
--   upgrade_completed         boolean              nullable
--   last_progress_check_at    timestamp without time zone nullable
--   created_at                timestamp without time zone nullable DEFAULT CURRENT_TIMESTAMP
--   updated_at                timestamp without time zone nullable DEFAULT CURRENT_TIMESTAMP
...
--   onboarding_completed      boolean              nullable
--   report_completed          boolean              nullable
--   onboarding_test_call_used boolean              nullable
--   created_at                timestamp without time zone nullable DEFAULT CURRENT_TIMESTAMP
--   updated_at                timestamp without time zone nullable DEFAULT CURRENT_TIMESTAMP
